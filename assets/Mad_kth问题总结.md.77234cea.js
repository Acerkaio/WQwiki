import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const _=JSON.parse('{"title":"kth问题总结","description":"","frontmatter":{},"headers":[],"relativePath":"Mad/kth问题总结.md","filePath":"Mad/kth问题总结.md","lastUpdated":1740448168000}'),l={name:"Mad/kth问题总结.md"},p=e(`<p>把这些转为markdown源码给我：</p><h1 id="kth问题总结" tabindex="-1">kth问题总结 <a class="header-anchor" href="#kth问题总结" aria-label="Permalink to &quot;kth问题总结&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">定义：</span></span>
