import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.e7363dcb.js";const m=JSON.parse('{"title":"number theory","description":"","frontmatter":{},"headers":[],"relativePath":"Math/number_theory.md","filePath":"Math/number_theory.md","lastUpdated":1738591681000}'),p={name:"Math/number_theory.md"},e=l(`<p>把这些转为markdown源码给我：</p><h1 id="number-theory" tabindex="-1">number theory <a class="header-anchor" href="#number-theory" aria-label="Permalink to &quot;number theory&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">经典结论：</span></span>
...
<span class="line"><span style="color:#24292e;">CF906D Power Tower：比较完整的例题</span></span></code></pre></div>`,3),t=[e];function c(o,r,i,y,g,d){return n(),a("div",null,t)}const k=s(p,[["render",c]]);export{m as __pageData,k as default};
