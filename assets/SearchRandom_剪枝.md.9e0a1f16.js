import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.e7363dcb.js";const m=JSON.parse('{"title":"剪枝","description":"","frontmatter":{},"headers":[],"relativePath":"SearchRandom/剪枝.md","filePath":"SearchRandom/剪枝.md","lastUpdated":1738592860000}'),l={name:"SearchRandom/剪枝.md"},p=e(`<h1 id="剪枝" tabindex="-1">剪枝 <a class="header-anchor" href="#剪枝" aria-label="Permalink to &quot;剪枝&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">剪枝的一般思路：</span></span>
...
<span class="line"><span style="color:#24292e;">	背包的单调性剪枝</span></span></code></pre></div>`,2),t=[p];function o(c,r,i,d,_,h){return a(),n("div",null,t)}const u=s(l,[["render",o]]);export{m as __pageData,u as default};
