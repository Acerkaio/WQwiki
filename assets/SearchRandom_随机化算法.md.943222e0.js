import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const k=JSON.parse('{"title":"随机化算法","description":"","frontmatter":{},"headers":[],"relativePath":"SearchRandom/随机化算法.md","filePath":"SearchRandom/随机化算法.md","lastUpdated":1740448168000}'),l={name:"SearchRandom/随机化算法.md"},p=e(`<p>把这些转为markdown源码给我：</p><h1 id="随机化算法" tabindex="-1">随机化算法 <a class="header-anchor" href="#随机化算法" aria-label="Permalink to &quot;随机化算法&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">爬山法：</span></span>
