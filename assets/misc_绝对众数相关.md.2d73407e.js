import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const h=JSON.parse('{"title":"绝对众数相关","description":"","frontmatter":{},"headers":[],"relativePath":"misc/绝对众数相关.md","filePath":"misc/绝对众数相关.md","lastUpdated":1738666900000}'),l={name:"misc/绝对众数相关.md"},p=e(`<p>把这些转为markdown源码给我：</p><h1 id="绝对众数相关" tabindex="-1">绝对众数相关 <a class="header-anchor" href="#绝对众数相关" aria-label="Permalink to &quot;绝对众数相关&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">定义：序列a[1~n]中出现次数大于floor(n/2)的数</span></span>
