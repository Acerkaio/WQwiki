import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const k=JSON.parse('{"title":"线性代数","description":"","frontmatter":{},"headers":[],"relativePath":"Math/线性代数.md","filePath":"Math/线性代数.md","lastUpdated":1740448168000}'),p={name:"Math/线性代数.md"},l=e(`<p>把这些转为markdown源码给我：</p><h1 id="线性代数" tabindex="-1">线性代数 <a class="header-anchor" href="#线性代数" aria-label="Permalink to &quot;线性代数&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">向量的线性无关：</span></span>
