import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const m=JSON.parse('{"title":"凸性相关","description":"","frontmatter":{},"headers":[],"relativePath":"Mad/凸性相关.md","filePath":"Mad/凸性相关.md","lastUpdated":null}'),p={name:"Mad/凸性相关.md"},l=e(`<h1 id="凸性相关" tabindex="-1">凸性相关 <a class="header-anchor" href="#凸性相关" aria-label="Permalink to &quot;凸性相关&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">定义：</span></span>
