import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const k=JSON.parse('{"title":"线性代数","description":"","frontmatter":{},"headers":[],"relativePath":"Math/线性代数.md","filePath":"Math/线性代数.md","lastUpdated":1738591681000}'),p={name:"Math/线性代数.md"},l=e(`<p>把这些转为markdown源码给我：</p><h1 id="线性代数" tabindex="-1">线性代数 <a class="header-anchor" href="#线性代数" aria-label="Permalink to &quot;线性代数&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">向量的线性无关：</span></span>
...
<span class="line"><span style="color:#24292e;">		若k为根，则去掉第k行第k列求值</span></span></code></pre></div>`,3),t=[l];function o(c,r,i,y,d,_){return n(),a("div",null,t)}const h=s(p,[["render",o]]);export{k as __pageData,h as default};
