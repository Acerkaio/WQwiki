import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const d=JSON.parse('{"title":"多项式","description":"","frontmatter":{},"headers":[],"relativePath":"Math/多项式.md","filePath":"Math/多项式.md","lastUpdated":1738591681000}'),l={name:"Math/多项式.md"},p=e(`<h1 id="多项式" tabindex="-1">多项式 <a class="header-anchor" href="#多项式" aria-label="Permalink to &quot;多项式&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">基础知识：</span></span>
...
<span class="line"><span style="color:#24292e;">	具体实现见闵可夫斯基和</span></span></code></pre></div>`,2),t=[p];function c(o,i,r,y,x,f){return n(),a("div",null,t)}const _=s(l,[["render",c]]);export{d as __pageData,_ as default};
