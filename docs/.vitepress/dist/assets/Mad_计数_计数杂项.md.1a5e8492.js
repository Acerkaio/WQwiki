import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const d=JSON.parse('{"title":"计数杂项","description":"","frontmatter":{},"headers":[],"relativePath":"Mad/计数/计数杂项.md","filePath":"Mad/计数/计数杂项.md","lastUpdated":null}'),l={name:"Mad/计数/计数杂项.md"},p=e(`<h1 id="计数杂项" tabindex="-1">计数杂项 <a class="header-anchor" href="#计数杂项" aria-label="Permalink to &quot;计数杂项&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">组合恒等式：</span></span>
