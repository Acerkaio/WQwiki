import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const h=JSON.parse('{"title":"鸽巢原理","description":"","frontmatter":{},"headers":[],"relativePath":"Math/鸽巢原理.md","filePath":"Math/鸽巢原理.md","lastUpdated":1738591681000}'),l={name:"Math/鸽巢原理.md"},p=e(`<p>把这些转为markdown源码给我：</p><h1 id="鸽巢原理" tabindex="-1">鸽巢原理 <a class="header-anchor" href="#鸽巢原理" aria-label="Permalink to &quot;鸽巢原理&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">基本内容：</span></span>
...
<span class="line"><span style="color:#24292e;">清澄 K大巨头</span></span></code></pre></div>`,3),o=[p];function t(c,i,r,d,y,_){return n(),a("div",null,o)}const x=s(l,[["render",t]]);export{h as __pageData,x as default};
