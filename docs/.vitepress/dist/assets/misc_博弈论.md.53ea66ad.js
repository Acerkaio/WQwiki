...
<span class="line"><span style="color:#24292e;">	再考虑当前的异或和，结合奇偶性，假如为偶数，那后手肯定赢了，否则先手赢</span></span></code></pre></div>`,3),o=[l];function c(t,i,r,y,d,m){return n(),a("div",null,o)}const G=s(p,[["render",c]]);export{S as __pageData,G as default};
