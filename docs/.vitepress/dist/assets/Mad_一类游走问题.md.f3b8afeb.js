import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const u=JSON.parse('{"title":"一类游走问题","description":"","frontmatter":{},"headers":[],"relativePath":"Mad/一类游走问题.md","filePath":"Mad/一类游走问题.md","lastUpdated":null}'),l={name:"Mad/一类游走问题.md"},p=e(`<h1 id="一类游走问题" tabindex="-1">一类游走问题 <a class="header-anchor" href="#一类游走问题" aria-label="Permalink to &quot;一类游走问题&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">通常可以看作从根节点出发，每次扩展一小部分，但是不太规律，只能用贪心解决</span></span>
