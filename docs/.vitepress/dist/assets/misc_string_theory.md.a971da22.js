import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const A=JSON.parse('{"title":"string theory","description":"","frontmatter":{},"headers":[],"relativePath":"misc/string_theory.md","filePath":"misc/string_theory.md","lastUpdated":1738666900000}'),l={name:"misc/string_theory.md"},p=e(`<p>把这些转为markdown源码给我：</p><h1 id="string-theory" tabindex="-1">string theory <a class="header-anchor" href="#string-theory" aria-label="Permalink to &quot;string theory&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">manacher：</span></span>
...
<span class="line"><span style="color:#24292e;">		cf232D Fence:差分转化成字符串匹配问题，然后就是套路DS</span></span></code></pre></div>`,3),t=[p];function c(o,i,r,y,d,m){return n(),a("div",null,t)}const _=s(l,[["render",c]]);export{A as __pageData,_ as default};
