import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const f=JSON.parse('{"title":"网络流算法","description":"","frontmatter":{},"headers":[],"relativePath":"Mad/网络流/网络流算法.md","filePath":"Mad/网络流/网络流算法.md","lastUpdated":1738666900000}'),l={name:"Mad/网络流/网络流算法.md"},p=e(`<h1 id="网络流算法" tabindex="-1">网络流算法 <a class="header-anchor" href="#网络流算法" aria-label="Permalink to &quot;网络流算法&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">最大流问题</span></span>
