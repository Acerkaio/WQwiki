import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const u=JSON.parse('{"title":"模拟费用流.","description":"","frontmatter":{},"headers":[],"relativePath":"Mad/模拟费用流.md","filePath":"Mad/模拟费用流.md","lastUpdated":null}'),l={name:"Mad/模拟费用流.md"},p=e(`<h1 id="模拟费用流" tabindex="-1">模拟费用流. <a class="header-anchor" href="#模拟费用流" aria-label="Permalink to &quot;模拟费用流.&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">核心思考方法：</span></span>
