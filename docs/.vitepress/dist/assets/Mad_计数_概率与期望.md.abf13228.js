import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const u=JSON.parse('{"title":"概率与期望","description":"","frontmatter":{},"headers":[],"relativePath":"Mad/计数/概率与期望.md","filePath":"Mad/计数/概率与期望.md","lastUpdated":null}'),p={name:"Mad/计数/概率与期望.md"},l=e(`<h1 id="概率与期望" tabindex="-1">概率与期望 <a class="header-anchor" href="#概率与期望" aria-label="Permalink to &quot;概率与期望&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">常见结论：</span></span>
