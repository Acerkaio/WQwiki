import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.e7363dcb.js";const P=JSON.parse('{"title":"背包与背包型DP","description":"","frontmatter":{},"headers":[],"relativePath":"Mad/DP/背包与背包型DP.md","filePath":"Mad/DP/背包与背包型DP.md","lastUpdated":null}'),l={name:"Mad/DP/背包与背包型DP.md"},p=e(`<h1 id="背包与背包型dp" tabindex="-1">背包与背包型DP <a class="header-anchor" href="#背包与背包型dp" aria-label="Permalink to &quot;背包与背包型DP&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">定义：</span></span>
