import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.e7363dcb.js";const m=JSON.parse('{"title":"经典问题","description":"","frontmatter":{},"headers":[],"relativePath":"SearchRandom/经典问题.md","filePath":"SearchRandom/经典问题.md","lastUpdated":1738592860000}'),p={name:"SearchRandom/经典问题.md"},l=e(`<p>把这些转为markdown源码给我：</p><h1 id="经典问题" tabindex="-1">经典问题 <a class="header-anchor" href="#经典问题" aria-label="Permalink to &quot;经典问题&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">哈密顿路：</span></span>
...
<span class="line"><span style="color:#24292e;">	有多项式复杂度做法，一般不考察</span></span></code></pre></div>`,3),t=[l];function o(c,r,i,d,_,y){return a(),n("div",null,t)}const u=s(p,[["render",o]]);export{m as __pageData,u as default};
